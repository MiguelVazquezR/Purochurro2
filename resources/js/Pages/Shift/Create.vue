...
const submit = () => {
    // Convertir objetos Date a formato H:i
            ...
            <div class="flex-1 flex flex-col gap-8 w-full min-w-0">
                ...
                <div class="sticky top-16 z-30 bg-surface-50/90 backdrop-blur-md py-4 border-b border-surface-200/50 flex items-center justify-between transition-all duration-300">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold tracking-tight text-surface-900">Nuevo turno</h1>
                            <p class="text-surface-500 text-sm mt-1 hidden md:block">Registra un nuevo horario de trabajo.</p>
                        </div>
                    </div>
