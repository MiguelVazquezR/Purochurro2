...
watch(() => form.phone, (val) => {
    ...
    // 2. Limitar a 10 dígitos máximo
    if (numbers.length > 10) {
        numbers = numbers.slice(0, 10);
    }

    // 3. Aplicar formato: 33 1245 5269
    let formatted = '';
...
// --- Lógica de Imagen (Foto de perfil) ---
            ...
            <div class="flex-1 flex flex-col gap-8 w-full min-w-0">
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold tracking-tight text-surface-900">Nuevo empleado</h1>
                            <p class="text-surface-500 text-sm mt-1 hidden md:block">Registra la información personal y
                                laboral.</p>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <InputText id="phone" v-model="form.phone" class="w-full"
                                        placeholder="Ej: 3312345678" maxlength="12" :invalid="!!form.errors.phone" />
                                    <small class="text-surface-400 text-xs">Será la contraseña temporal.</small>
                        ...
                        <div class="bg-white rounded-3xl shadow-sm border border-surface-200 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div
                                    ...
                                    <p class="text-xs text-blue-600 mb-2">Selecciona los bonos que se calcularán
                                        automáticamente en cada nómina.</p>
